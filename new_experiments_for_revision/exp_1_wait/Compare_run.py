"""
WAIT vs vLLM vs Sarathi 公平比较实验

运行脚本：遍历所有 scheduler × arrival rate 组合
"""
...
def run_comparison():
    ...
    print("=" * 60)
    print("WAIT vs vLLM vs Sarathi 公平比较实验")
    print("=" * 60)
...
def run_single_scheduler(scheduler_name):
    ...
    print("=" * 60)
    print(f"单调度器实验: {scheduler_name.upper()}")
    print("=" * 60)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="WAIT vs vLLM vs Sarathi 公平比较实验")
