#!/usr/bin/env python3
"""
非PD分离实验：仅 WAIT (rate, total_limit)
...
def main():
    ...
    # 输出基础目录
    BASE_OUTPUT_DIR = "/home/lg/vidur_or/new_experiments_for_revision/exp_1_wait/non_PD分离_default_baseline"

    # ============================================================
    # ============ 配置区域结束 ============
    # ============================================================

    total_experiments = len(WAIT_EXPERIMENTS)
    count = 0
    success_count = 0
    failed_experiments = []  # 记录失败的实验

    print("=" * 60)
    print("非PD分离实验：仅 WAIT")
    print("=" * 60)
