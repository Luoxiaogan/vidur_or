#!/usr/bin/env python3
"""
PD_compare_analysis.py - PD分离实验 滑动窗口 Throughput & Latency 综合分析
...
def plot_rate_vs_metrics(
    ...
    fig.suptitle(f"PD Separated - Rate vs Metrics (BigWindow: [{THROUGHPUT_START_TIME}, {THROUGHPUT_END_TIME}] sec)",
                 fontsize=14, fontweight='bold')
...
def main():
    print("=" * 60)
    print("PD_compare_analysis.py - PD分离实验 Throughput & Latency 综合分析")
    print("=" * 60)
