...
# 输出路径
OUTPUT_DIR = "/root/vidur_or/mixing_experiments_for_DJ/sglang_mixing/0427_exp.lg_not_coprime/output"
...
async def run_experiment(engine, requests):
    ...
    tasks = []
    for req in requests:
        sampling_params = {"max_new_tokens": req["decode"], "ignore_eos": True}
