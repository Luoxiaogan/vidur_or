...
&\geq M^{\pi} + \sum_{k=2}^m (l + l_{k-1}') \left(n_k + \theta_k^{-1} \ln\!\left( \tfrac{m(1+\zeta T/d_0)}{\delta} \right)\right) \\
    &= O\!\left( 2M^\pi + \sum_{k=2}^m \theta_k^{-1}  (l + l_{k-1}') \ln\!\left( \tfrac{m(1+\zeta T/d_0)}{\delta} \right) \right),
\end{aligned}
\]
...
\ln\left( \frac{m(1+\zeta T/d_0)}{\delta} \right) \biggr),
    \end{aligned}
\end{equation}
where $\theta_k>0$ is the unique solution of \(e^{-\theta_k n_k}(1-p_k+p_ke^{\theta_k})^{n_{k-1}}=1\), with lower bound $8(n_k-n_{k-1}p_k)/n_{k-1}$ for \(k\ge2\).
