...
For real-world testing, we use the dataset from \cite{zheng2023lmsys},\endnote{The dataset is available at \url{https://huggingface.co/datasets/lmsys/lmsys-chat-1m}.} which contains over 210,000 prompts from Vicuna and Chatbot Arena. We treat questions as prompts and answers as decoded tokens. Figure \ref{fig:distribution} shows the distribution of prefill and decode lengths. We randomly sample 50,000 prompts and simulate arrivals via a Poisson process.
