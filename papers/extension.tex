...
\begin{figure}[ht]
    ...
    \caption{Memory-bound components under low arrival rate (total rate = 50, $T = 200$). Left: $\delta = 0.1$; Right: $\delta = 10^{-5}$.}
...
\begin{figure}[ht]
    ...
    \caption{Memory-bound components under high arrival rate (total rate = 500, $T = 200$). Left: $\delta = 0.1$; Right: $\delta = 10^{-5}$.}
...
\begin{figure}[ht]
    ...
    \caption{Memory-bound components with varying time horizons (total rate = 50, $\delta = 0.001$). Left: $T = 20$; Right: $T = 2000$.}
