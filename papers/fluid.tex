...
This equilibrium batch size balances arrivals and completions. The denominator $\left(1 - d_1\lambda_j(l_j'+1)(l_j + l_j'/2)\right)$ represents the fraction of iteration time available for processing; as this fraction approaches zero, the batch size grows unbounded (approaching instability).
% \begin{comment}
